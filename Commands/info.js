...
module.exports = {
	...
	execute(message, args) {
        ...
        { name: 'Invite LibertyBot To Another Server!', value: `[Invite Link](https://discord.com/oauth2/authorize?client_id=853455948848300043&scope=bot+applications.commands)`},
	    )
	    .setTimestamp()
