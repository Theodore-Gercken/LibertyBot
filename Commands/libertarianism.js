...
module.exports = {
	...
	execute(message, args) {
      ...
      .setTitle('Libertarianism')
	    .setDescription(`Hello :wave:! I'd love to engage you in a quick conversation to convince you that libertarianism is the correct philosophy. Because I'm not a real human, I'm going to talk and then present options for you to choose from. The possibilities are numbered and you will type your desired options number in command form (ex: "libertarianism 2"). This is meant to convince those who aren't libertarians but feel free to use it to improve your argument skills!\n\nThis conversation is going to be reasonably simple. We'll identify your ideology and then link libertarianism to it. For starters, I am defining libertarianism as the philosophy that the least government and most individual freedom is the optimal state of affairs.\n\nLet's start with a simple question: do we own our own bodies absolutely?\n\n1: Yes\n4: No`)
