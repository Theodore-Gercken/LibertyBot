...
module.exports = {
	...
	execute(message, args) {
      ...
      .addFields(
        ...
        { name: 'Patreon', value: '*Making LibertyBot available to everyone 24/7 costs $8 a month, so if you want to help out to make sure it keeps existing, feel free to donate. Any money in excess of what is needed to host LibertyBot will be donated to the Libertarian Youth Caucus or the Frontier Project.*\n[Link](https://www.patreon.com/libertybot)'},
	    )
